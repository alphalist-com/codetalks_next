    ...
    <div class="-mt-16 h-screen">
      <div class="relative isolate overflow-hidden h-full pt-14" id="hero">
        <div class="absolute inset-0 -z-10">
          <img
            src="https://codetalks.dehttps://codetalks.de/img/sections/hero/aboutPage.jpg"
            alt=""
    ...
    <div class="px-12">
      ...
      <div class="text-center mt-20 pb-10">
        ...
        <NormalTextBlock class="mx-auto">
          ...
          to warrant exchange of information in a relaxed atmosphere. <br><br> Nobody
          should be discriminated against or harassed at code.talks!
          ...
          channels. <br><br>All visitors, no matter if they are participants, speakers,
          curators, partners, or organizers, are asked to comply with these
          rules. When they purchase their ticket, book a partnership, or agree
          to hold a talk, visitors confirm that they will comply with our
          expectations to their conduct at code.talks. Anyone found in violation
          of these rules will be subject to sanctions imposed by the event
          staff, up to ban from the conference without any entitlement to a
          refund of the admission fee. <br><br>Please contact a member of the organizer
          team immediately if you feel harassed or notice that someone else is
          being harassed, or if there are any other problems. You can recognize
          us easily by our code.talks crew t-shirts. All helpers will be ready
          to listen to you and do what they can to solve the issue. Of course,
          you may also contact us by email at any time: <NuxtLink class="text-cota-primary"  href="mailto:info@codetalks.com" > info@codetalks.com</NuxtLink>
        </NormalTextBlock>
      </div>
    </div>
    <Dialog
