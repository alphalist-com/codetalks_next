      ...
      >
        ...
        >
          ...
          >
            <div class="relative">
              <img
                src="/landing_page/partner_collage_1.jpg"
                alt=""
          ...
          <div class="mr-auto w-44 flex-none space-y-8 pt-36 sm:mr-0 lg:pt-0">
            <div class="relative">
              <img
                src="/landing_page/partner_collage_2.jpg"
                alt=""
                class="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
              />
              <div
            ...
            <div class="relative">
              <img
                src="/landing_page/partner_collage_3.jpg"
                alt=""
                class="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
              />
              <div
          ...
          <div class="w-44 flex-none space-y-8 lg:pt-36">
            <div class="relative">
              <img
                src="/landing_page/partner_collage_4.jpg"
                alt=""
                class="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
              />
              <div
            ...
            <div class="relative">
              <img
                src="/landing_page/partner_collage_5.jpg"
                alt=""
                class="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
              />
              <div
