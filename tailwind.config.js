...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'gradient-custom': 'linear-gradient(to bottom right, rgba(255, 255, 255, 0.35) 0%, rgba(255, 255, 255, 0.1) 30%, transparent 90%, rgba(0, 0, 0, 0.7) 100%)',
      },
      boxShadow: {
        'frosted-edge': '2px 2px 2px -1px rgba(255, 255, 255, 0.1), 0 35px 60px -15px rgba(0, 0, 0, 0.3)',
      },
      colors: {
        'cota-primary': '#1aba8b',
        'cota-on-primary': '#020804',
        'cota-highlight-on-primary': '#000000', 
        'cota-secondary': '#ffffff',
        'cota-on-secondary': '#020804',
